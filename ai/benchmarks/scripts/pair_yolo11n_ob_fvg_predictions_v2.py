...
OUTPUT_DIR = Path("ai/benchmarks/reports/yolo11n_pairing")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

OUTPUT_CSV = OUTPUT_DIR / "yolo11n_ob_fvg_pairs_v2.csv"
OUTPUT_SUMMARY = OUTPUT_DIR / "yolo11n_ob_fvg_pairing_summary_v2.md"
...
def main():
    ...
    lines = []
    lines.append("# YOLO11n OB-FVG Pairing v2 Summary")
    lines.append("")
    lines.append("## Input")
    lines.append("")
    ...
    print("YOLO11n pairing finished.")
