...
PRED_LABEL_DIR = Path("runs/detect/ai/benchmarks/runs/yolo11s_final_test_2025_predict_conf025/labels")

OUTPUT_DIR = Path("ai/benchmarks/reports/yolo11s_pairing_conf025")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

OUTPUT_CSV = OUTPUT_DIR / "yolo11s_conf025_ob_fvg_pairs_v2.csv"
OUTPUT_SUMMARY = OUTPUT_DIR / "yolo11s_conf025_ob_fvg_pairing_summary_v2.md"
