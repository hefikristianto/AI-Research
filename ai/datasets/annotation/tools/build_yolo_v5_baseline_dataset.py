...
SOURCE_DIR = Path("ai/datasets/annotation/auto_labels_v5")
...
OUTPUT_DIR = Path("ai/datasets/annotation/exports/yolo_v5_baseline")
...
def write_dataset_yaml():
    content = """# AI-TDSS YOLO v5 Baseline Dataset

path: ai/datasets/annotation/exports/yolo_v5_baseline
