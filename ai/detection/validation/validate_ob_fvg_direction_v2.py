...
OUTPUT_CSV = OUTPUT_DIR / "ob_fvg_direction_validation_v2.csv"
OUTPUT_SUMMARY = OUTPUT_DIR / "ob_fvg_direction_validation_summary_v2.md"
...
def main():
    ...
    summary = []
    summary.append("# OB-FVG Direction Validation v2")
    summary.append("")
